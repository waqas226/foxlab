        ...
        <div class="m-3">
          <div class="row">
            <div class="col-md-4">
              ...
              <input type="date" class="form-control" id="wo_date" name="wo_date" value="{{ $workOrder->wo_date ? \Carbon\Carbon::parse($workOrder->wo_date)->format('Y-m-d') : now()->format('Y-m-d') }}" required>
            </div>
            <div class="col-md-4">
