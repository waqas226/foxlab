...
@section('page-script')
<script src="{{asset('assets/js/manage-todo.js')}}"></script>
@endsection
...
<div class="card">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddCompany" aria-labelledby="offcanvasAddCompanyLabel">
    <div class="offcanvas-header">
      <h5 id="offcanvasAddCompanyLabel" class="offcanvas-title">Add New Todo</h5>
    ...
    <div class="offcanvas-body mx-0 flex-grow-0 pt-0 h-100">
      <form class="add-new-user pt-0" id="addNewTodoForm" method="POST" onsubmit="return false;">
        ...
        <div class="mb-3">
          <label class="form-label" for="next_visit_todo">Next Visit Todo</label>
          <input type="text" class="form-control" id="next_visit_todo" placeholder="Next Visit Todo" name="next_visit_todo" required />
        </div>
       
        <div class="mb-3">
          <label class="form-label" for="toodo_date">Due Date</label>
          <input type="text" class="form-control flatpickr-validation" id="toodo_date" placeholder="YYYY-MM-DD" name="toodo_date" required />
        </div>
