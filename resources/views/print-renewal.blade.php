...
<div id="header">
    <img src="https://helpdesk.talerman.com/images/renewals.jpg" style="width: 40px"  >
</div>
									...
									white-space: nowrap;
									top: 40%"></span>
				<table width="100%" cellpadding="2" cellspacing="2" border="0" style="padding:10px 110 30px 50px;"><tr>
						  <td colspan="2">
						  	  <table width="100%">
							  	<tr>
					  ...
					  <tr>
						...
						<tr><td colspan="2" style="padding-bottom:20px;"><span style="display: inline-block;padding-left: 20px;"><b>Upcoming Renewals list :</b></span><br/>
	...
	<span style="width:325px;font-weight: 600;">Description</span></div></li>
	<br/>
	@foreach($renewals as $renewal)
	<li style="line-height:20px; 
	color:{{(strtotime($renewal->renewal_date) >= strtotime(date('Y-m-d'))?strtotime($renewal->renewal_date) == strtotime(date('Y-m-d'))?'Black':'Blue':'Red')}};">
		<div style="display:flex;">
			<span style="display: inline-block;margin-right: 10px;width: 100px;">{{$renewal->renewal_date}}</span>
		<span style="width:450px">{{$renewal->title}}</span></div>
	</li>
	@endforeach
	</ul>
</td>
