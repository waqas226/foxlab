...
@section('page-script')
<script src="{{asset('assets/js/manage-roles.js')}}"></script>
@endsection
...
<!-- Users List Table -->
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Dashboard /</span> Manage Roles
</h4>
<div class="card">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddCompany" aria-labelledby="offcanvasAddCompanyLabel">
    <div class="offcanvas-header">
      <h5 id="offcanvasAddCompanyLabel" class="offcanvas-title">Add Role</h5>
   ...
   <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasUpdateCompany" aria-labelledby="offcanvasUpdateCompanyLabel">
    <div class="offcanvas-header">
      <h5 id="offcanvasUpdateCompanyLabel" class="offcanvas-title">Update Role</h5>
      <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body mx-0 flex-grow-0 pt-0 h-100">
      <form class="add-new-user pt-0" id="UpdateCompanyForm" method="POST" onsubmit="return false;">
        ...
        <div class="mb-3">
          <label class="form-label" for="name">Role Name</label>
          <input type="text" class="form-control" id="recordname" placeholder="Role Name" name="name" required />
        </div>
