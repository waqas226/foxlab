...
<body>
    ...
    <div id="content" style="width: 100%; padding: 20px;">
                        ...
                        <tr>
                            <td width="100%" align="center">
                                <div class="headerlogo">
                                    <b><h3>{{$constant->company_name}}</h3></b>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td width="100%" align="center">
                                <div class="headerlogo" style="margin:0px 0px 20px 0px;">
                                    <img src="{{ asset('uploads/'.$constant->logo) }}" style="max-height: 80px;" />
                                </div>
                            </td>
                        </tr>
                    </table>
        ...
        <table width="100%" cellpadding="2" cellspacing="2" border="0" style="padding:10px 0 30px 0;">
            <tr>
                <td width="100%"><b>Work Order Signature:</b>
                    @if($workOrder->signature)
                        <img src="{{$workOrder->signature}}" alt="Signature" style="max-height: 80px;">
                    @else
