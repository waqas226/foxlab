...
@section('page-script')
<script src="{{asset('assets/js/manage-checklist.js')}}"></script>
@endsection
    ...
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        ...
        <div class="text-center mb-4">
          <h3 class="mb-2">Import Checklists          </h3>
         
        </div>
        <form id="importForm" class="row g-3"  action="{{ route('checklists.import') }}" method="POST" enctype="multipart/form-data">
        @csrf  
        <div class="col-12">
