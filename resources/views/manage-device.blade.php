...
@section('page-script')
<script src="{{asset('assets/js/manage-device.js')}}"></script>
@endsection
...
<div class="card">
  <div class="card-header border-bottom">
    ...
    <div class="d-flex justify-content-between align-items-center row pb-2 gap-3 gap-md-0">
      ...
      <select id="deviceCompany" class="form-select text-capitalize user-company"><option value=""> Select Company </option>
      ...
      <thead class="border-top">
        <tr>
          <th></th>
            ...
            <th>Device Type</th><th>Make</th><th>Model</th>
        <th>SN</th>
        <th>Asset</th>
        <th>Last PM</th><th>Next PM</th>
        <th>Company</th>
        <th>Checklist</th>
          <th>Actions</th>
        </tr>
...
<div class="modal-onboarding modal fade animate__animated" id="errorModal" tabindex="-1" aria-hidden="true">
          <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content text-center">
              ...
              <div class="modal-body p-0 scrollbar">
    ...
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        ...
        <div class="text-center mb-4">
          <h3 class="mb-2">Import Devices List          </h3>
         
        </div>
        <form id="importForm" class="row g-3"  action="{{ route('device.import') }}" method="POST" enctype="multipart/form-data">
        @csrf  
        <div class="col-12">
